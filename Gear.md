...
| Level | Name               | Expenses Tracked                                                                        | Monthly Income (Credits) | Living Expenses                                                      | Appropriate Settings                                       | Focus                                             |
| ----- | ------------------ | --------------------------------------------------------------------------------------- | ------------------------ | -------------------------------------------------------------------- | ---------------------------------------------------------- | ------------------------------------------------- |
| 1     | Subsistence        | All expenses, even small ones (e.g., food, ammo).<br>OR, only items above 1% of income. | 0 - 1,000                | 90% Income                                                           | Low-fantasy medieval, post-apocalyptic, extreme poverty.   | Survival and resource management.                 |
| 2     | Working Class      | only items above 1% of income.                                                          | 1,001 - 2,000            | 75% Income                                                           | Most fantasy, historical, average modern characters.       | Balance between detail and convenience.           |
| 3     | Comfortable        | only items above 1% of income.                                                          | 2,001 - 10,000           | 60% Income                                                           | Modern middle-class, space opera, established adventurers. | Story and major resource decisions.               |
...
### The Black Market
To find a restricted item without the required legal authorization, first an Availability Roll must be made. If it's available, only a successful SCHOLAR: Streetwise or INFLUENCE: Trader roll determines if you can find a seller. If you fail, roll for Mishaps: 1D6 per level of Wealth of a settlement/district (1D6 Poor, 2D6 Moderate, 3D6 Wealthy). If an X is rolled during the Mishap roll, roll 1D6 on the mishap table below, referencing Restriction Level
...
| ---------------- | --------- | -------------- | ---------- | ------------- | --------------- | ------- | ------------- | ----------- | ------------ | ---------- | ------ |
| PSM              | 75        | 0              | 1          | 5.7mm         | 5               | 2       | Long          | 8           | smallarm     | 0.25       | 3/R    |
| Service Revolver | 75        | 1              | 1          | 0.38 SPC      | 5               | 2       | Long          | 6           | smallarm     | 0.5        | 1/F    |
...
| **Weapon**        | **Price** | **Gear Bonus** | **Damage**                | **Ammo Type** | **Reliability** | **ROF** | **Max Range** | **Mag Cap** | **Features**            | **Weight** | Supply |
| ----------------- | --------- | -------------- | ------------------------- | ------------- | --------------- | ------- | ------------- | ----------- | ----------------------- | ---------- | ------ |
| Molotov Cocktail  | 15        |                | –                         | –             | –               | –       | Medium        | –           | Juryrig, Fire 2D8 (10m) | 1          | 1/X    |
| Smoke             | 25        |                | Fills 10m area with smoke | –             | –               | –       | Medium        | –           | –                       | 0.25       | 3/R    |
| Improvised        | 25        |                | 2                         | –             | –               | –       | Medium        | –           | Juryrig, Blast 2D8      | 1          | 2/X    |
| Fragmentation     | 30        |                | 2                         | –             | –               | –       | Medium        | –           | Blast 2D8               | 0.25       | 4/X    |
| Anti Tank         | 50        |                | 6                         | –             | –               | –       | Medium        | –           | AP, Blast 2D6           | 0.25       | 4/X    |
| White Phosphorous | 50        |                | –                         | –             | –               | –       | Medium        | –           | Fire 2D10 (10m)         | 0.25       | 4/X    |
...
| VEHICLE        | PASSENGERS | MANEUVERABILITY | RELIABILITY | ARMOR | AVAILABILITY | COST |
| -------------- | ---------- | --------------- | ----------- | ----- | ------------ | ---- |
| Civilian Car   | 4          | 3               | 4           | 1     | 1/F          |      |
| Civilian Truck | 3          | 1               | 8           | 1     | 1/F          |      |
| Motorcycle     | 1          | 5               | 2           | -     | 1/F          |      |
| Police car     | 2          | 4               | 4           | 3     | 2/R          |      |
| Armored car    | 2          | 3               | 5           | 3     | 3/R          |      |
| Police truck   | 20         | 1               | 8           | 3     | 2/R          |      |
