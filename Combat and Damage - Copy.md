...
- You may perform more actions beyond that, but they incur the following penalty to ALL declared actions in the round:
	...
	- Calculate the total penalty remove 1 penalty point.
	- E.g. I do a Called Shot to Head (-2) -7, (slow), Shoot -5, Move, Reload, Aim
...
The fastest way to recover from being Broken by damage is for someone else  to treat you by successfully rolling for MEDICAL AID. This is a slow action. If successful, you immediately heal a number of damage points equal to the number of X rolled. Further MEDICAL AID rolls have no effect, and the same person cannot try again unless more advanced medical gear is applied, or until the next time you are incapacitated by damage.
If no one helps you within a QD, you recover become unbroken and heal 1 point of damage.

If you have lost any attribute points, you will recover all lost attribute points by RESTING or SLEEPING for a Quarter Day. This assumes that you are not HUNGRY, THIRSTY or suffering from another condition that blocks recovery.
