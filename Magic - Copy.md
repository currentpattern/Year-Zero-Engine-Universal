...
- **Directly altering the conditions of a person's body** (e.g. location, state) with a direct magical effect (e.g. curse, magical weapon, teleportation, freezing, etc), allows them to resist with the INSIGHT specialties Incorruptible, Mindful, or Magician.  
