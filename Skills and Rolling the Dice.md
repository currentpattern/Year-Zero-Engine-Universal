...
Raising a parent skill **does not** increase specializations. Base skill is the floor. 
...
>> **EXAMPLE 2** Let's say you have FIREARMS 1. Let's say you have the FIREARMS specializations FIREARMS: PISTOL at 5 and FIREARMS: RIFELEMAN at 5. You want to raise FIREARMS from level 1 to level 2. The cost is 10 XP. The amount of experience to raise FIREARMS: PISTOL from 1 to 2 is 3 XP. The amount of experience to raise FIREARMS: RIFLEMAN from 1 to 2 is 3 XP. Raising the base skill of FIREARMS to 2 triggers a refund of the XP equivalent to the amount of XP it took to raise specializations to the equivalent level. This, in effect, makes the cost of raising FIREARMS from 1 to 2 is 4 XP. 10 XP (FIREARMS) - 3 XP (PISTOLS) - 3 XP (RIFLEMAN) = 4 XP total
...
>Machinegunner: Firing full-auto machineguns
>Heavy Ordinance: Firing rocket launchers, missile launchers, etc.
...
CRAFTING: Crafting modern or high technology uses TECHNICAL, similarly to general crafting rules, with some slight differences. 
...
FINDING FOLLOWERS & COHORTS: Once per week, anyone can try to recruit followers by rolling INFLUENCE + Global Reputation + ½ Local Justice Reputation. At 7 Global Reputation, you may roll performance to try to find a Cohort. See SECTION ON HIRELINGS, FOLLOWERS, AND COHORTS.
...
RIDE: Any adventurer can sit on a horse or another type of mount without falling off, but more advanced maneuvers can require a skill roll. ANIMAL HANDLING: Rider replaces MOVE when you attempt difficult jumps or other maneuvers on beast back. Use the mount’s AGILITY in these cases to determine the number of Base Dice for the roll, not your EMPATHY. You can push the roll, but you run the risk of exhausting the mount.

| ANIMAL HANDLING: Rider Effects                                                                                                                                                                                                                                           |           |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------- |
| Choose 1 applicable Bonus Effect<br>- Cancel additional Suppression successes when moving through a Field of Fire (OPTIONAL RULE)<br>- Gain +1 modification to a later skill roll relating to this one<br>- You impress someone. +1 to one INFLEUNCE roll on them later. | -2 / XX   |
| Choose 2 applicable Bonus Effects.                                                                                                                                                                                                                                       | -3 / XXX  |
| Moving one further distance when you move twice.                                                                                                                                                                                                                         | -3 / XXX  |
| On long journeys, Moving your mount one extra hex square in a Quarter Day, in normal terrain.                                                                                                                                                                            | -3 / XXX  |
| Choose 2 applicable Bonus Effects.                                                                                                                                                                                                                                       | -5 / XXXX |
| **Increasing the mount’s Movement** Rate one step for 1 round. Every extra success increases the movement rate by 1 step for 1 round. E.G. Horse rate goes from 2 to 3, allowing 30m run actions.                                                                        | -5 / XXXX |

COMMAND TAME ANIMALS: Using ANIMAL HANDLING: Whisperer, you can attempt to command a tame animal to do your bidding. If the Animal has not been trained in the task, the roll is modified by the Animal Type DM and the Task Complexity DM (see below).
+1 to ANIMAL HANDLING: Whisperer if:
- The task has a low risk of harm.
- You perform the task with them.
-1 to an ANIMAL HANDLING: Whisperer if:
- Your side is outnumbered
- The task is obviously dangerous
- Animal is already hurt
- Animal is hungry

TRAINING A TAME ANIMAL: Once an animal is tame, or already domesticated, you may train it to follow commands, simple or complex. This process is modified by the animal type, and by the complexity of the desired command/level of training. The process involves 1 modified ANIMAL HANDLING: Whisperer roll that takes 2 fewer days than the total modifier (e.g. if the training is at -7, the roll requires 5 days). You must spend at least 2 hours each day working on the training, or the process begins anew.
Failing a Training roll means the training failed to stick. You may begin again with a +2 DM. -2 DM for every BANE included in the failure. 
*Example: I have EMP 3, ANIMAL HANDLING: Whisperer 5. I want to train a falcon to follow combat orders. -7 DM, 5 days. I train 2h every day, and after 5th session, roll 3 BASE, 2 NEGATIVE. 2 banes appeared in my failure. I can begin the process again at -9 total. I should just get another falcon who doesn't hate me.*

| Animal Type                                     | DM  |
| ----------------------------------------------- | --- |
| dogs, horses                                    | 0   |
| cats, goats, parrots, rats                      | -1  |
| raven/crows, falcons, dolphins, ferrets, cattle | -2  |
| Bears, wolves, primates, elephants              | -3  |
| big cats, crocodiles, foxes, octopi             | -4  |
| hippos, komodo dragons, moose, wolverines       | -5  |

| Level of Task Complexity                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | DM         |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| **Basic Tasks**: come/follow/stay repertoire and basic tricks, hunt and signal when it finds prey                                                                                                                                                                                                                                                                                                                                                                                                          | 0 / X      |
| **Working Tasks**: herd other animals, retrieve named objects, guard designated areas, carry messages to known location                                                                                                                                                                                                                                                                                                                                                                                    | -2 / XX    |
| **Guardian Duties**: Stay and defend when handler is Broken, Lead handler through hazardous terrain, Work cooperatively with other trained animals, Differentiate between welcome and unwelcome visitors                                                                                                                                                                                                                                                                                                   | -3 / XXX   |
| **Assistive Capabilities**: Assist you in getting help you when you are Broken (restore 1 point of broken attribute), Track specific individuals by scent across varied terrain, Navigate to new locations based on verbal directions                                                                                                                                                                                                                                                                      | -4 / XXX   |
| **Tactical & Crisis Response**: fight for you following specific basic orders during combat (When it is your turn to fight, roll ANIMAL HANDLING: Whisperer (Slow Action), the animal will fight and follow your orders for one round, at your turn in the initiative order. For every success beyond what was necessary to succeed, grant +1 to all your animal's combat rolls.), Detect and alert to specific types of danger, Handle complex social interactions (like mediating between other animals) | -5 / XXXX  |
| **Near-Human Comprehension**: Understand and respond to abstract concepts, Make complex independent decisions in novel situations, Coordinate with multiple handlers in chaotic situations, Perform emergency responses without prior specific training                                                                                                                                                                                                                                                    | -7 / XXXXX |
DISCOURAGING WILD ANIMALS: When you encounter a wild animal, you can attempt to discourage it from attacking by communicating on a primal level. You must be at CLOSE range or closer, and you must be aware of the animal’s presence. Roll an opposed roll for ANIMAL HANDLING: Tamer against the animal’s STRENGTH – larger animals are harder to frighten off.  

TAME WILD ANIMALS:  Through a long period of work, you can use ANIMAL HANDLING: Tamer to tame a wild animal. The animal must be caught, and to successfully tame it you must use ANIMAL HANDLING: Tamer successfully as many times as the animal’s STRENGTH, spread out over an equal number of days. You must spend a Quarter Day (see page 144) every day taming the animal, or the process begins anew. It is possible to tame SOME non-demonic monsters. There will be a penalty ranging from -1 to -3.  

Failing a Taming roll doesn’t stop the taming process, just slows it down by a day where no progress was made. The process continues as long as you spend a Quarter Day working on it. If a failure includes a BANE, mark it as a CRITICAL FAILURE. Each time you accrue a critical failure, roll 1D6. If the roll is equal to or less than the number of CRITICAL FAILURES you have, the taming process is botched and the animal is now too traumatized to continue.
## **MEDICAL AID**
...
MOVING THE CRITICALLY INJURED: If someone suffering from a lethal critical injury attempts to move themselves, they must make an immediate **death save**. If you want to move another person suffering from a lethal critical injury, you must make a MEDICAL AID: EMT/Field Surgeon roll (no action) – failure means the injured must make an immediate death save. When carrying another person, each running action becomes a SLOW ACTION.
...
| ----------------------------------------------------------------------- | -------- |
| STABILIZE FATAL CRITICAL INJURY.                                        | -2 / XX  |
| Healing certain permanent critical injuries with 2D6 days healing time. | -4 / XXX |
...
>	**Rapid Reload:** speeds reloading up one level: prepping arrows/slings is free, reloading firearms is FAST.  
...
>	**Seen it all**: Once per session, you may ignore all rolled banes. If you do so, your acclimatization to the situation prevents you from gaining the Bane's Willpower points as well. 
...
OTHER  
>	**Breakthrough**: Once per session, you may automatically succeed on some investigator check. You get that one success and don't roll. 
