...
**SPEED**: When in vehicle combat that is not technically a Chase, this rating is how many 10m increments the vehicle can move as 1 fast action.
...
**RAMMING ENEMIES** : Most vehicles can be used as weapons (e.g. to simply run your target over). It counts as a close combat attack but both attacker and defender roll for DRIVING. The **Base Damage Rating of the attack equals your vehicle’s RELIABILITY rating divided by two, rounded up, + Speed difference of the attack.** If an attack was successful, **the attacking vehicle suffers damage equal to Base Damage Rating - 2.** 
...
**WRECKED**: Vehicle suffers CRITICAL DAMAGE, and is inoperable. Roll D12 on the Critical Damage Table. Every point of damage that brings the vehicle's RELIABILITY rating below 0 is inflicted as direct damage to all passengers (Blunt damage, Armor counts). If passengers see the crash coming, they can brace themselves for the hit by rolling MOVE. Each rolled X reduces the damage by one.
...
A player or NPC is allowed to cancel a planned maneuver, but no other maneuver may be chosen instead – the participant simply does nothing in the Round. Maneuvers require skill rolls. These rolls can be affected by the chase obstacle revealed by the GM before the maneuver is resolved. Skills and other factors used for vehicles are indicated. 
...
| Hide            | You quickly duck into a side alley or hide behind something.                  | Prey         | Stealth / Driving vs. Observation. Can only be done at MEDIUM range or more. -2 at MEDIUM, +2 at DISTANT. | Chase over or ambush attack against pursuer at range of choice.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| Cut Off         | You try to find a shortcut and cut off the prey.                              | Pursuer      | Move / Driving vs. Move / Driving. -1 at MEDIUM range, -2 at LONG range, -3 DISTANT.                      | Range becomes ARM'S L, and an immediate hand-to-hand combat /ramming attack can be made. If you fail the Cutt Off maneuver, or roll a tie, the range is increased to DISTANT. If the range was already DISTANT, the chase is over.                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
# CHASE OBSTACLES
Each Round, after the participants have secretly chosen their maneuvers, the GM randomly generates a chase obstacle. The obstacles provide flavor for the chase and can also affect the maneuvers chosen by the participants in different ways. The GM is free to adapt the obstacles to the situation at hand, or even choose to create obstacles freely as needed. 

SPECIAL ENVIRONMENTS
- **A crowd that must be persuaded to move:** The prey must roll Persuasion (no action) to convince them to move. Success gives a +2 modifier to any Hide maneuver. A failed roll means that the prey’s maneuver fails automatically. 
- **Other Hostiles block the way:** −2 modifier to Pursue/Flee, Hide and Stand and Shoot. Anyone who performs the Stand and Shoot maneuver will be attacked. (guards/police blocking the chase) 
- **D6 potential hostiles block**.  Prey must roll Persuasion (no action) to be allowed to pass. A failed roll means that the hostiles attack – the chosen maneuver fails automatically and one hostile attacks in close combat. If the Persuasion roll succeeds, the hostiles will attack the pursuer instead. (street thugs)
...
| 6   | Somewhat open space (standard route)                                                  |                                          | -2                                       |                                          |                              | +2                                           |                                                              |
| 7   | massive barrier (truck in way)                                                        | -2, fail = D6 damage                     |                                          |                                          | +1                           |                                              |                                                              |
| 8   | Narrow pass/alley                                                                     |                                          |                                          |                                          |                              |                                              | Succeed move or chase ends / cancel maneuver and move slowly |
| 9   | Mazelike, immobile (trees, parkling lot, pedestrian street)                           |                                          |                                          | -2                                       | +2                           |                                              |                                                              |
| 10  | Purely visual/physically weak clutter (signs, crowd)                                  |                                          | +2                                       |                                          |                              | Fail = collateral damage to cause of clutter | Pursuer Observation or fail maneuver                         |
| 11  | Funneled straightaway: cut-off route is blocked                                       | +2                                       |                                          |                                          | -2                           | +2                                           |                                                              |
| 12  | Harmful breakable obstacle (Food Stall, glass, storefront, parked motorcycles, trees) | Prey succeed Drive/Might or take 10D dam | Prey succeed Drive/Might or take 10D dam | Prey succeed Drive/Might or take 10D dam |                              |                                              |                                                              |
